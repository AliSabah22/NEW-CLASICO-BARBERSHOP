      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-serif text-4xl font-bold mb-4">Why Choose Clasico</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We combine traditional techniques with modern style to deliver an exceptional grooming experience
            </p>
          </div>
