        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p>Email: info@clasicobarbershop.com</p>
            </div>
          </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link href="/services" className="block hover:text-gold transition-colors">
                Services
              </Link>
              <Link href="/gallery" className="block hover:text-gold transition-colors">
                Gallery
              </Link>
              <Link href="/team" className="block hover:text-gold transition-colors">
                Our Team
              </Link>
